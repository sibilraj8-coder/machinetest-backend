...
SECRET_KEY = 'django-insecure-&dzl@=$xnz*$bz^p+$)e=f+fy(zzo&-7k6#%fp_ke!#&0&pf!p'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'todo_database',               # Database name
        'USER': 'demo_user',                        # MySQL username
        'PASSWORD': 'demo123',            # MySQL password
...
# If you want more secure CORS in production:
